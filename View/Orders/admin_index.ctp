<div class="orders admin-index">
    ...
    <div class="table">
        ...
        <?php foreach($orders as $order): ?>
            ...
            <?php $row .= $this->Html->tag('span', isset($order['Payment']) ? $order['Payment']['stripe_id'] : '', array('class' => 'table-cell')); ?>
            <?php $row .= $this->Html->tag('span', isset($order['Payment']) ? $this->Number->stripe($order['Payment']['stripe_amount']) : '', array('class' => 'table-cell text-right')); ?>
