...
class AppController extends Controller {
    ...
    {
        $secure = array('invoices/getLineItem', 'watches/active', 'coupons/archive', 'contacts/deleteModal', 'coupons/deleteModal', 'users/login', 'orders/checkout', 'orders/totalCart.json', 'orders/getAddress.html', 'orders/getCountry.json', 'orders/checkout.json');
        $here = trim($this->here, '/'); 
